...
/**
 * Generate bukti pendaftaran PDF (Support Multiple/Kolektif)
 */
export async function generateBuktiPendaftaran(pesertaData) {
  const pesertaList = Array.isArray(pesertaData) ? pesertaData : [pesertaData]
